...
#New Instruction#: “Explore the basic components of an atom, then explain how the components are organized and how they interact."###""",
...
#New Instruction#: “Carefully read the details of the article, noting the key events and information provided, based on your understanding, summarize the article in one sentence. The incident happened on Fife Street between 04:30 BST and 05:00 BST on Saturday. The police have appealed for witnesses to the crash. York Road is closed between its junctions with Skegoneill Avenue and Alexandra Park Avenue. Diversions are in place.”###""",
