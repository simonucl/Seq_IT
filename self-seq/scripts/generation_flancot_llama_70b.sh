...
# python3 self-seq/data/process_multi_it.py \
# 	--file_path self-seq/data/flancot_extract/flancot_15k_Meta-Llama-3-70B-Instruct_iter_0-generate_instruct-refine-response-final.jsonl \
# 	--output_file self-seq/data/flancot_extract/flancot_llama70b_iteration_1.jsonl
