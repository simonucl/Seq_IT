...
python make_data_all.py --dataset xquad --target en --typename base

for LANG in es de zh ru
do 
  python make_data_all.py --dataset xquad --target ${LANG} --typename base
done

for LANG in el ar el ar vi hi tr th
do 
  python make_data_all.py --dataset xquad --target ${LANG} --typename trans
done
