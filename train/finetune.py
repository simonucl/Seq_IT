...
def train(
    ...
    try:
        ...
        if "llama" in base_model.lower():
            ...
            tokenizer = QWenTokenizer.from_pretrained(base_model, trust_remote_code=True)
        else:
    ...
    print("batch_size", micro_batch_size * gradient_accumulation_steps)
    ...
    # fixing PEFT and huggingface conflict as per
    # https://github.com/tloen/alpaca-lora/issues/483
